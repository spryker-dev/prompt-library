...
const method_call_processor_v2_1 = require("./method-call-processor-v2");
...
class EdgeIndexer {
    constructor(parser, methods, ownerToFactory, factoryReturnByClassMethod, classImplements, logger, _debug) {
        ...
        const methodCallProcessor = new method_call_processor_v2_1.MethodCallProcessor(ownerToFactory, factoryReturnByClassMethod, this.buildInterfaceMap(classImplements), logger);
...
//# sourceMappingURL=edge-indexer-v2.js.map