...
exports.CodeElementIndexer = void 0;
...
const inherit_doc_resolver_1 = require("../resolvers/inherit-doc-resolver");
const ast_node_kinds_1 = require("../../constants/ast-node-kinds");
class CodeElementIndexer {
    ...
    processAst(ast, filePath, classes, methods, ownerToFactory, classImplements) {
        ...
        this.parser.walk(ast, (node) => {
            ...
            if (node.kind === ast_node_kinds_1.AstNodeKind.INTERFACE) {
                ...
                if (fqn) {
                    classes.set(fqn, { file: filePath, kind: ast_node_kinds_1.ClassKind.INTERFACE });
                }
                return;
            }
...
exports.CodeElementIndexer = CodeElementIndexer;
//# sourceMappingURL=code-element-indexer.js.map