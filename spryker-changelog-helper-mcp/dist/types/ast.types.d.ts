...
export type ASTNode = BaseNode | Identifier | Name | Parameter | Method | Property | PropertyStatement | Class | Interface | Namespace | UseItem | UseGroup | Variable | Call | StaticCall | PropertyLookup | StaticLookup | New | Assign | Return;
