...
class ModuleReportGenerator {
    ...
    generateModuleReport(moduleName, moduleData, fullReport) {
        ...
        const validationInfo = {
            ...
            hasBreakingChanges: versionRecommendation.recommendedBump === analyzer_config_1.AnalyzerConfig.versionBumpTypes.major,
    ...
    deduplicateByMethodName(methods) {
        ...
        for (const method of methods) {
            ...
            if (!seen.has(methodName)) {
                ...
                if (method.method.includes(analyzer_config_1.AnalyzerConfig.filePatterns.interfaceSuffix)) {
                    seen.set(methodName, method);
                }
            }
        }
