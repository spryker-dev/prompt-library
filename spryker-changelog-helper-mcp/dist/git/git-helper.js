...
const git_constants_1 = require("../analysis/constants/git-constants");
class GitHelper {
    ...
    getFileDiff(baseCommit, file) {
        return (0, child_process_1.execSync)(`git diff --unified=${git_constants_1.DiffSettings.CONTEXT_LINES} ${baseCommit} HEAD -- "${file}"`, {
            cwd: this.root,
            encoding: 'utf-8',
        }).toString();
    }
