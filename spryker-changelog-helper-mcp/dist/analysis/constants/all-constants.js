...
AnalyzerConfig.gitStatus = exports.GitStatus;
AnalyzerConfig.fileExtensions = exports.FileExtension;
AnalyzerConfig.patterns = {
    methodSignature: exports.PhpPattern.METHOD_SIGNATURE,
    diffMethodSignature: exports.PhpPattern.DIFF_METHOD_SIGNATURE,
    visibilityModifier: exports.PhpPattern.VISIBILITY_MODIFIER,
    closingBrace: exports.PhpPattern.CLOSING_BRACE,
    className: exports.PhpPattern.CLASS_NAME,
    namespace: exports.PhpPattern.NAMESPACE,
    classNameFromPath: exports.PhpPattern.CLASS_NAME_FROM_PATH,
    testDirectory: exports.FilePattern.TEST_DIRECTORY,
    transferSchema: exports.FilePattern.TRANSFER_XML,
    sprykerFilePath: exports.PublicApiPattern.SPRYKER_FILE_PATH,
};
AnalyzerConfig.spryker = {
    vendors: exports.SprykerVendors,
    layers: exports.SprykerLayers,
    namespaceSeparator: exports.SprykerSeparator.NAMESPACE,
    pathSeparator: exports.SprykerSeparator.PATH,
    publicApiClassSuffixes: exports.PublicApiClassSuffixes,
    publicApiPatterns: { plugin: exports.PublicApiPattern.PLUGIN },
    internalApiLayers: exports.InternalApiLayers,
    communicationLayerClasses: exports.CommunicationLayerClass,
};
AnalyzerConfig.phpKeywords = {
    static: 'static',
};
AnalyzerConfig.filePatterns = {
    composerJson: exports.FilePattern.COMPOSER_JSON,
};
AnalyzerConfig.changeTypes = exports.ChangeType;
AnalyzerConfig.internalChangeTypes = exports.InternalChangeType;
AnalyzerConfig.relevantNonPhpExtensions = exports.RelevantNonPhpExtensions;
AnalyzerConfig.getEntrypointPattern = getEntrypointPattern;
