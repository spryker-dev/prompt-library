---
title: Generate Glue API for an existing Feature

description: A comprehensive prompt for generating Glue API code inside an existing Feature in the Spryker core monorepo Feature folder.

when_to_use: When you need to generate Storefront or Backend Glue APIs (or both) for an existing Spryker Feature, following the official structure and conventions

tags: [sprykerFeature, feature-glue, feature-api]
